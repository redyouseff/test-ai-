...
const AppointmentDetails = () => {
  ...
  const handleCancel = async () => {
    try {
      ...
      const response = await fetch(
        getApiUrl(`/api/v1/appointments/${id}/cancel`),
        {
          method: "PATCH",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleComplete = async () => {
    try {
      ...
      // Split the strings into arrays right before sending to the API
      const requestBody = {
        diagnosis: completionDetails.diagnosis,
        symptoms: completionDetails.symptoms[0]
          ?.split(",")
          .map((s) => s.trim())
          .filter(Boolean) || ["None"],
        treatment: {
          medications: completionDetails.treatment.medications.filter(
            (med) => med.name.trim() !== ""
          ),
          recommendations: completionDetails.treatment.recommendations[0]
            ?.split(",")
            .map((r) => r.trim())
            .filter(Boolean) || ["None"],
        },
  ...
  const handleSymptomsChange = (value: string) => {
    // Store the raw input value including commas
    setCompletionDetails((prev) => ({
      ...prev,
  ...
  const handleFileUpload = async (
    ...
    try {
      ...
      const response = await fetch(
        getApiUrl(`/api/v1/appointments/${id}/upload`),
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      <div className="max-w-7xl mx-auto px-8 py-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-3">
            <Badge
              className={`px-3 py-1 rounded-md ${getStatusBadgeStyle(
                appointment?.status || ""
              )}`}
            >
              {appointment?.status
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-base mt-1">
                            Patient has been experiencing mild headaches over
                            the past week
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="bg-white rounded-lg border p-6">
                    ...
                    <div className="space-y-6">
                      <div>
                        ...
                        <Badge
                          className={`mt-2 px-3 py-1 rounded-md ${getStatusBadgeStyle(
                            appointment?.status || ""
                          )}`}
                        >
                          {appointment?.status
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-700">
                    {appointment.appointmentReport.diagnosis}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {appointment.appointmentReport.symptoms.map(
                      (symptom, index) => (
                ...
                <div>
                  ...
                  {appointment.appointmentReport.treatment.medications.length >
                    0 && (
                    <div className="mb-4">
                      <h4 className="font-medium mb-2">Medications</h4>
                      <div className="space-y-2">
                        {appointment.appointmentReport.treatment.medications.map(
                          (med, index) => (
                            <div
                              key={index}
                  ...
                  {appointment.appointmentReport.treatment.recommendations
                    .length > 0 && (
                    <div>
                      <h4 className="font-medium mb-2">Recommendations</h4>
                      <ul className="list-disc list-inside space-y-1">
                        {appointment.appointmentReport.treatment.recommendations.map(
                          (rec, index) => (
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    {appointment.appointmentReport.followUp.required
                      ? "Required"
                      : "Not Required"}
                  </p>
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Completed on:{" "}
                    {new Date(
                      appointment.appointmentReport.completedAt
                    ).toLocaleString()}
                  </p>
                </div>
              </div>
          ...
          {activeTab === "files" && (
            <div className="p-6">
                    ...
                    <div className="flex flex-col items-center justify-center pt-5 pb-6">
                      {isUploading ? (
                        ...
                        <>
                          ...
                          <p className="text-sm text-gray-500">
                            Upload any relevant files (Images, Documents, etc.)
                          </p>
                        </>
                      )}
                    </div>
              ...
              {appointment?.uploadedFiles &&
                Array.isArray(appointment.uploadedFiles) &&
                        ...
                        >
                            ...
                            <div className="w-12 h-12 rounded-lg bg-gray-100 flex items-center justify-center overflow-hidden">
                              ...
                              file.fileType === "image/jpg" ? (
                                <img
                                  src={file.fileUrl}
                                  alt={
                                    file.fileName.split("/").pop() || "Preview"
                                  }
                          ...
                          <Button
                            onClick={() =>
                              handleDownload(
                                file.fileUrl,
                                file.fileName.split("/").pop() || "download"
                              )
                            }
        ...
        <div className="hidden">
          ...
          <p>
            Should Show Buttons:{" "}
            {String(isDoctor && appointment?.status === "pending")}
          </p>
        </div>
        ...
        <Dialog open={showCompleteDialog} onOpenChange={setShowCompleteDialog}>
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              ...
              <p className="text-sm text-gray-500">
                Enter the medical details for this appointment
              </p>
            </DialogHeader>
            ...
            <div className="space-y-6 py-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  value={completionDetails.symptoms[0] || ""}
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  value={completionDetails.treatment.recommendations[0] || ""}
