    ...
    const fetchSpecialties = async () => {
      ...
      try {
        const response = await axios.get(
          "https://care-insight-api-9ed25d3ea3ea.herokuapp.com/api/v1/specialties"
        );
  ...
  const onPatientSubmit = async (values: PatientFormValues) => {
    ...
    const userData = {
      ...
      chronicDiseases: values.chronicDiseases
        ? values.chronicDiseases.split(",").map((item) => item.trim())
        : [],
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormDescription>
                              Enter any medications you are currently taking,
                              separated by commas
                            </FormDescription>
                            <FormMessage />
                          </FormItem>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            Enter your professional certifications, separated by
                            commas
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      ...
                      <div className="mt-6">
                        ...
                        <div className="space-y-4">
                          {Object.entries(workHours).map(([day, hours]) => (
                            <div
                              key={day}
                              className="flex flex-col md:flex-row gap-4 p-3 border rounded-md"
                            >
